...
exports.recommendSkills = functions
    .region('us-central1')
    ...
    if (!openaiApiKey) {
        throw new functions.https.HttpsError('failed-precondition', 'Server misconfigured: OPENAI_API_KEY is not set.');
    }
    try {
...
exports.createTherapistClientLink = functions
    .region('us-central1')
    .https.onCall(async (data, context) => {
    // TODO: check consent and create document
    return { ok: true };
});
exports.exportPdf = functions
    .region('us-central1')
    .https.onCall(async (data, context) => {
